...
class BaseSSL(nn.Module):
    ...
    def prepare_data(self):
        ...
        if self.hparams.data == 'cifar':
            ...
            self.trainset = datasets.ImageFolder(traindir, transform=TwoCropTransform(train_transform))
            self.testset = datasets.ImageFolder(valdir, transform=TwoCropTransform(test_transform))
        else:
