    ...
    def transforms(self):
        if self.hparams.data == 'cifar':
            ...
            if self.hparams.aug_ver == 0 :
                ...
                train_transform=CustomAug_changeemoji_10012111_imgcorrupt(self.hparams)
...
class CustomAug_changeemoji_10012111_imgcorrupt(object):
    def __init__(self, hparams):
